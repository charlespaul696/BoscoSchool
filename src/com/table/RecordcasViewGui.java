 ...
 * @author charles
 */
public class RecordcasViewGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "CAs Record Data", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Dialog", 1, 14))); // NOI18N
        ...
        stu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "student id", "term section", "CA 1", "CA 2", "CA 3"
            }
        ));
    ...
    private void stuviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_stuviewActionPerformed
        try {
            String sql = "select * from cas_record";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecordcasViewGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RecordcasViewGui().setVisible(true);
            }
        });
    }
